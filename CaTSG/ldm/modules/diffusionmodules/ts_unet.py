...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        if self.use_cfg:
            ...
            # Use context_dim for null_classes_emb to match the actual context input dimension
            null_emb_dim = context_dim if context_dim is not None else repre_emb_channels
            self.null_classes_emb = nn.Parameter(th.randn(1, null_emb_dim))
        else:
